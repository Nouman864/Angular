...
@Component({
  selector: 'app-ratingresturant',
  templateUrl: './ratingresturant.component.html',
  styleUrls: ['./ratingresturant.component.scss'],
})
export class RatingresturantComponent implements OnInit {
  service: any;
  event: any;
  form: any;
  loading: boolean;
  ...
  click3rd(item: any) {
    ...
    clickForth(item: any) {
      ...
      this.n1 = 'star'; this.n2 = 'star'; this.n3 = 'star'; this.n4 = 'star';
       ...
       async addReview()  {
        let owner;
        let restrntid = this.event._id;
        console.log(owner);
        console.log(restrntid);
        this.loading = true;
    let user;
    ...
    try{
      ...
      user = decoded['data']._id;
         ...
         console.log(this.d);
         obj['resturantid'] = restrntid;
         obj['rating'] = this.star;
         obj['date'] = this.d;
         const observable = await this.booksService.reviewresturant(
           obj
         );
