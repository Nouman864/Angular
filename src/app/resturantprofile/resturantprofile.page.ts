...
@Component({
  selector: 'app-resturantprofile',
  templateUrl: './resturantprofile.page.html',
  styleUrls: ['./resturantprofile.page.scss'],
})
export class ResturantprofilePage implements OnInit {
  c1 = '';  c2 = '';  c3 = '';  c4 = ''; c5 = ''; c6 = '';
